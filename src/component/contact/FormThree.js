...
const FormThree = () => {
    ...
    return (
        ...
        <div className="form-group mb--40">
            ...
            <textarea name="contact-message" aria-labelledby='textarea section' id="contact-message" className="form-control textarea" cols="30" rows="6"></textarea>
        </div>
        <div className="form-group text-end">
            <button type="submit" aria-label='submit button' arial-label="submit-btn" className="axil-btn btn-fill-primary w-auto btn-primary" name="submit-btn">SEND</button>
        </div>
        <div className="form-group">
            {result ? <Result /> : null}
        </div>
